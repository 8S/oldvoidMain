...
int balancestatic2(AcYut &bot,double p)     //p is ideal condition and the values are continiously taken by COM1
{	double x,y,z,xr,yr,zr,error,corr;
	const double (&COM1)[AXES] = bot.getRotCOM();
	x=390;
	z=0;
	xr=390;
	zr=0;
